        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 sm:p-12 border border-white/10">
              ...
              <p className="text-white/90 text-base sm:text-lg leading-relaxed mb-6 font-source-sans">
                The P024 offers a solid 38-hour power reserve and smooth automatic winding. Its thin profile was critical, allowing us to maintain our target case thickness under 11mm, a crucial part of Arima&apos;s design DNA. We had to compromise on the thickness.
              </p>
